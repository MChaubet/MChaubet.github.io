  ...
  const V = (e, t) => {
    ...
    r[d]('pointerdown', e.onTouchStart, { passive: !1 }),
      ...
      i.updateOnWindowResize
        ? e[c](l.ios || l.android ? 'resize orientationchange observerUpdate' : 'resize observerUpdate', X, !0)
    ...
    function (e) {
      ...
      function M() {
        ...
        'string' == typeof a.el && t.isElement && (i = t.el.shadowRoot.querySelector(a.el)),
          ...
          i &&
            ((r = i.querySelector(`.${t.params.scrollbar.dragClass}`)), r || ((r = g('div', t.params.scrollbar.dragClass)), i.append(r))),
              ...
              if (s < -t.minTranslate()) t.slideTo(t.activeIndex);
                ...
                if (r.freeMode.momentum) {
                  ...
                  if (
                    ...
                    if (
                      ((e = o ? Math.abs((-p - t.translate) / t.velocity) : Math.abs((p - t.translate) / t.velocity)), r.freeMode.sticky)
                    ) {
      ...
      ne({
        ...
        setTranslate: () => {
          ...
          if (((s.style.transformOrigin = `50% 50% -${o / 2}px`), (s.style['-webkit-transform-origin'] = `50% 50% -${o / 2}px`), c.shadow))
            if (p)
              m.style.transform = `translate3d(0px, ${r / 2 + c.shadowOffset}px, ${-r / 2}px) rotateX(90deg) rotateZ(0deg) scale(${
                c.shadowScale
              })`;
            else {
