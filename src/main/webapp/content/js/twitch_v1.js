    ...
    var e = {
              ...
              for (u.s(); !(i = u.n()).done; ) {
                ...
                if ('' !== l) {
                  var c = p(t.decode ? l.replace(/\+/g, ' ') : l, '='),
                    ...
                    d = f[0],
                    m = f[1];
                  (m = void 0 === m ? null : ['comma', 'separator', 'bracket-separator'].includes(t.arrayFormat) ? m : h(m, t)),
                    r(h(d, t), m, n);
                }
              }
            } catch (e) {
                        ...
                        return function (t) {
                          return function (r, n) {
                            ...
                            return void 0 === n || (e.skipNull && null === n) || (e.skipEmptyString && '' === n)
                              ...
                              : [].concat(
                                  i(r),
                                  null === n ? [[m(t, e), '[', o, ']'].join('')] : [[m(t, e), '[', m(o, e), ']=', m(n, e)].join('')]
                                );
                          };
                        };
                      case 'bracket':
                        return function (t) {
                          return function (r, n) {
                            return void 0 === n || (e.skipNull && null === n) || (e.skipEmptyString && '' === n)
                              ? r
                              : [].concat(i(r), null === n ? [[m(t, e), '[]'].join('')] : [[m(t, e), '[]=', m(n, e)].join('')]);
                          };
                        };
                      case 'colon-list-separator':
                        return function (t) {
                          return function (r, n) {
                            return void 0 === n || (e.skipNull && null === n) || (e.skipEmptyString && '' === n)
                              ? r
                              : [].concat(i(r), null === n ? [[m(t, e), ':list='].join('')] : [[m(t, e), ':list=', m(n, e)].join('')]);
                          };
                        };
                      case 'comma':
                      case 'separator':
                        ...
                        return function (r) {
                          return function (n, o) {
                            return void 0 === o || (e.skipNull && null === o) || (e.skipEmptyString && '' === o)
                              ? n
                              : ((o = null === o ? '' : o),
                                0 === n.length ? [[m(r, e), t, m(o, e)].join('')] : [[n, m(o, e)].join(e.arrayFormatSeparator)]);
                          };
                        };
                      default:
                        return function (t) {
        ...
        693: function (e, t, r) {
          ...
          (e.exports = function (e, t, r) {
            return (
              (t = n(t)) in e ? Object.defineProperty(e, t, { value: r, enumerable: !0, configurable: !0, writable: !0 }) : (e[t] = r), e
            );
          }),
            (e.exports.__esModule = !0),
            (e.exports.default = e.exports);
        ...
        var E = {
          ...
          S = (function (e) {
            function r() {
              ...
              return (t._embedWindow = null), (t._playerState = E), window.addEventListener('message', t._handleResponses.bind(t)), t;
            }
            return (
              t(r, e),
